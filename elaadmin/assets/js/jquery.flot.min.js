...
! function(a) {
    a.color = {}, a.color.make = function(t, i, e, o) {
        var n = {};
        return n.r = t || 0, n.g = i || 0, n.b = e || 0, n.a = null != o ? o : 1, n.add = function(t, i) { for (var e = 0; e < t.length; ++e) n[t.charAt(e)] += i; return n.normalize() }, n.scale = function(t, i) { for (var e = 0; e < t.length; ++e) n[t.charAt(e)] *= i; return n.normalize() }, n.toString = function() { return 1 <= n.a ? "rgb(" + [n.r, n.g, n.b].join(",") + ")" : "rgba(" + [n.r, n.g, n.b, n.a].join(",") + ")" }, n.normalize = function() {
            function t(t, i, e) { return i < t ? t : e < i ? e : i }
            return n.r = t(0, parseInt(n.r), 255), n.g = t(0, parseInt(n.g), 255), n.b = t(0, parseInt(n.b), 255), n.a = t(0, n.a, 1), n
        }, n.clone = function() { return a.color.make(n.r, n.b, n.g, n.a) }, n.normalize()
    ...
    }, a.color.parse = function(t) { var i, e = a.color.make; if (i = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/.exec(t)) return e(parseInt(i[1], 10), parseInt(i[2], 10), parseInt(i[3], 10)); if (i = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]+(?:\.[0-9]+)?)\s*\)/.exec(t)) return e(parseInt(i[1], 10), parseInt(i[2], 10), parseInt(i[3], 10), parseFloat(i[4])); if (i = /rgb\(\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*\)/.exec(t)) return e(2.55 * parseFloat(i[1]), 2.55 * parseFloat(i[2]), 2.55 * parseFloat(i[3])); if (i = /rgba\(\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\s*\)/.exec(t)) return e(2.55 * parseFloat(i[1]), 2.55 * parseFloat(i[2]), 2.55 * parseFloat(i[3]), parseFloat(i[4])); if (i = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(t)) return e(parseInt(i[1], 16), parseInt(i[2], 16), parseInt(i[3], 16)); if (i = /#([a-fA-F0-9])([a-fA-F0-9])([a-fA-F0-9])/.exec(t)) return e(parseInt(i[1] + i[1], 16), parseInt(i[2] + i[2], 16), parseInt(i[3] + i[3], 16)); var o = a.trim(t).toLowerCase(); return "transparent" == o ? e(255, 255, 255, 0) : e((i = n[o] || [0, 0, 0])[0], i[1], i[2]) };
...
function(q) {
    ...
    function Q(t, i) {
        ...
        if (null == e && ((e = document.createElement("canvas")).className = t, q(e).css({ direction: "ltr", position: "absolute", left: 0, top: 0 }).appendTo(i), !e.getContext)) {
    ...
    function o(x, t, i, o) {
        var C = [],
            ...
            M = 0,
            T = 0,
            W = { processOptions: [], processRawData: [], processDatapoints: [], processOffset: [], drawBackground: [], drawSeries: [], draw: [], bindEvents: [], drawOverlay: [], shutdown: [] },
            z = this;

        function I(t, i) { i = [z].concat(i); for (var e = 0; e < t.length; ++e) t[e].apply(this, i) }
        ...
        function n(t) {
            C = function(t) {
                ...
                function() {
                    ...
                    function m(t, i, e) { i < t.datamin && i != -p && (t.datamin = i), e > t.datamax && e != p && (t.datamax = e) }
                    for (q.each(A(), function(t, i) { i.datamin = u, i.datamax = d, i.used = !1 }), t = 0; t < C.length; ++t)(n = C[t]).datapoints = { points: [] }, I(W.processRawData, [n, n.data, n.datapoints]);
                    for (t = 0; t < C.length; ++t) {
                        if (n = C[t], h = n.data, !(f = n.datapoints.format)) {
                            if ((f = []).push({ x: !0, number: !0, required: !0 }), f.push({ y: !0, number: !0, required: !0 }), n.bars.show || n.lines.show && n.lines.fill) {
                                var x = !!(n.bars.show && n.bars.zero || n.lines.show && n.lines.zero);
                                f.push({ y: !0, number: !0, required: !1, defaultValue: 0, autoscale: x }), n.bars.horizontal && (delete f[f.length - 1].y, f[f.length - 1].x = !0)
                            }
                    ...
                    q.each(A(), function(t, i) { i.datamin == u && (i.datamin = null), i.datamax == d && (i.datamax = null) })
                }()
        }

        function g(t, i) { var e = t[i + "axis"]; return "object" == typeof e && (e = e.n), "number" != typeof e && (e = 1), e }

        function A() { return q.grep(p.concat(m), function(t) { return t }) }

        function f(t) { var i, e, o = {}; for (i = 0; i < p.length; ++i)(e = p[i]) && e.used && (o["x" + e.n] = e.c2p(t.left)); for (i = 0; i < m.length; ++i)(e = m[i]) && e.used && (o["y" + e.n] = e.c2p(t.top)); return void 0 !== o.x1 && (o.x = o.x1), void 0 !== o.y1 && (o.y = o.y1), o }

        function b(t, i) { return t[i - 1] || (t[i - 1] = { n: i, direction: t == p ? "x" : "y", options: q.extend(!0, {}, t == p ? S.xaxis : S.yaxis) }), t[i - 1] }

        function a() { D && clearTimeout(D), h.unbind("mousemove", L), h.unbind("mouseleave", O), h.unbind("click", R), I(W.shutdown, [h]) }
        ...
        function r(e) {
            var t = e.labelWidth,
                ...
                h = !0,
                f = !1;
            q.each(n ? p : m, function(t, i) { i && (i.show || i.reserveSpace) && (i === e ? f = !0 : i.options.position === o && (f ? c = !1 : s = !1), f || (h = !1)) }), c && (r = 0), null == a && (a = h ? "full" : 5), isNaN(+a) || (l += +a), n ? (i += l, "bottom" == o ? (w.bottom += i + r, e.box = { top: d.height - w.bottom, height: i }) : (e.box = { top: w.top + r, height: i }, w.top += i + r)) : (t += l, "left" == o ? (e.box = { left: w.left + r, width: t }, w.left += t + r) : (w.right += t + r, e.box = { left: d.width - w.right, width: t })), e.position = o, e.tickLength = a, e.box.padding = l, e.innermost = s
        }
        ...
        function l() {
            ...
            if (q.each(i, function(t, i) {
                ...
                var a = q.grep(i, function(t) { return t.show || t.reserveSpace });
                for (q.each(a, function(t, i) {
                        ...
                        ! function(t) {
                            ...
                            t.tickGenerator || (t.tickGenerator = function(t) { for (var i, e, o, n = [], a = (e = t.min, (o = t.tickSize) * Math.floor(e / o)), r = 0, l = Number.NaN; i = l, l = a + r * t.tickSize, n.push(l), ++r, l < t.max && l != i;); return n }, t.tickFormatter = function(t, i) {
                            ...
                            q.isFunction(e.tickFormatter) && (t.tickFormatter = function(t, i) { return "" + e.tickFormatter(t, i) });
                            if (null != e.alignTicksWithAxis) {
                                var c = ("x" == t.direction ? p : m)[e.alignTicksWithAxis - 1];
                                if (c && c.used && c != t) {
                                    var h = t.tickGenerator(t);
                                    if (0 < h.length && (null == e.min && (t.min = Math.min(t.min, h[0])), null == e.max && 1 < h.length && (t.max = Math.max(t.max, h[h.length - 1]))), t.tickGenerator = function(t) { var i, e, o = []; for (e = 0; e < c.ticks.length; ++e) i = (c.ticks[e].v - c.min) / (c.max - c.min), i = t.min + i * (t.max - t.min), o.push(i); return o }, !t.mode && null == e.tickDecimals) {
                        ...
                        function(t) {
                            ...
                            for (t.ticks = [], i = 0; i < n.length; ++i) {
                                var a = null,
                                    r = n[i];
                                "object" == typeof r ? (e = +r[0], 1 < r.length && (a = r[1])) : e = +r, null == a && (a = t.tickFormatter(e, t)), isNaN(e) || t.ticks.push({ v: e, label: a })
                            }
                ...
                ! function() {
                    ...
                    q.each(A(), function(t, i) { i.reserveSpace && i.ticks && i.ticks.length && ("x" === i.direction ? (e.left = Math.max(e.left, i.labelWidth / 2), e.right = Math.max(e.right, i.labelWidth / 2)) : (e.bottom = Math.max(e.bottom, i.labelHeight / 2), e.top = Math.max(e.top, i.labelHeight / 2))) }), w.left = Math.ceil(Math.max(e.left, w.left)), w.right = Math.ceil(Math.max(e.right, w.right)), w.top = Math.ceil(Math.max(e.top, w.top)), w.bottom = Math.ceil(Math.max(e.bottom, w.bottom))
                }(), q.each(a, function(t, i) { var e; "x" == (e = i).direction ? (e.box.left = w.left - e.labelWidth / 2, e.box.width = d.width - w.left - w.right + e.labelWidth) : (e.box.top = w.top - e.labelHeight / 2, e.box.height = d.height - w.bottom - w.top + e.labelHeight) })
            }
            M = d.width - w.left - w.right, T = d.height - w.bottom - w.top, q.each(i, function(t, i) {
                    ! function(t) {
                        ...
                        "x" == t.direction ? (e = t.scale = M / Math.abs(n(t.max) - n(t.min)), o = Math.min(n(t.max), n(t.min))) : (e = -(e = t.scale = T / Math.abs(n(t.max) - n(t.min))), o = Math.max(n(t.max), n(t.min))), t.p2c = n == i ? function(t) { return (t - o) * e } : function(t) { return (n(t) - o) * e }, t.c2p = a ? function(t) { return a(o + t / e) } : function(t) { return o + t / e }
                    }(i)
                ...
                function() {
                    ...
                    for (var t, i, e = [], o = [], n = !1, a = S.legend.labelFormatter, r = 0; r < C.length; ++r)(t = C[r]).label && (i = a ? a(t.label, t) : t.label) && o.push({ label: i, color: t.color });
                    if (S.legend.sorted)
                        ...
                        o.sort(function(t, i) { return t.label == i.label ? 0 : t.label < i.label != l ? 1 : -1 })
                    }
        ...
        function F(t, i) {
            for (var e, o, n, a, r = A(), l = 0; l < r.length; ++l)
                if ((e = r[l]).direction == i && (t[a = i + e.n + "axis"] || 1 != e.n || (a = i + "axis"), t[a])) { o = t[a].from, n = t[a].to; break }
        ...
        function u() {
            ...
            e && (o = S.grid.borderColor, "object" == typeof e || "object" == typeof o ? ("object" != typeof e && (e = { top: e, right: e, bottom: e, left: e }), "object" != typeof o && (o = { top: o, right: o, bottom: o, left: o }), 0 < e.top && (y.strokeStyle = o.top, y.lineWidth = e.top, y.beginPath(), y.moveTo(0 - e.left, 0 - e.top / 2), y.lineTo(M, 0 - e.top / 2), y.stroke()), 0 < e.right && (y.strokeStyle = o.right, y.lineWidth = e.right, y.beginPath(), y.moveTo(M + e.right / 2, 0 - e.top), y.lineTo(M + e.right / 2, T), y.stroke()), 0 < e.bottom && (y.strokeStyle = o.bottom, y.lineWidth = e.bottom, y.beginPath(), y.moveTo(M + e.right, T + e.bottom / 2), y.lineTo(0, T + e.bottom / 2), y.stroke()), 0 < e.left && (y.strokeStyle = o.left, y.lineWidth = e.left, y.beginPath(), y.moveTo(0 - e.left / 2, T + e.bottom), y.lineTo(0 - e.left / 2, 0), y.stroke())) : (y.lineWidth = e, y.strokeStyle = S.grid.borderColor, y.strokeRect(-e / 2, -e / 2, M + e, T + e))), y.restore()
        }
        ...
        function v(t) {
            t.lines.show && function(t) {
                ...
                a && (y.fillStyle = a, function(t, i, e) {
                    ...
                    for (; !(0 < n && r > o.length + n);) {
                        var f = o[(r += n) - n],
                            ...
                            d = o[r],
                            p = o[r + s];
                        if (l) { if (0 < n && null != f && null == d) { h = r, n = -n, s = 2; continue } if (n < 0 && r == c + n) { y.fill(), l = !1, s = 1, r = c = h + (n = -n); continue } }
                        if (null != f && null != d) {
                            if (f <= d && f < i.min) {
                                if (d < i.min) continue;
                ...
                var i = c.bars.fill ? function(t, i) { return P(c.bars, c.color, t, i) } : null;
                (function(t, i, e, o, n, a) { for (var r = t.points, l = t.pointsize, s = 0; s < r.length; s += l) null != r[s] && k(r[s], r[s + 1], r[s + 2], i, e, o, n, a, y, c.bars.horizontal, c.bars.lineWidth) })(c.datapoints, t, t + c.bars.barWidth, i, c.xaxis, c.yaxis), y.restore()
        ...
        function P(t, i, e, o) { var n = t.fill; if (!n) return null; if (t.fillColor) return Y(t.fillColor, e, o, i); var a = q.color.parse(i); return a.a = "number" == typeof n ? n : .4, a.normalize(), a.toString() }
        z.setData = n, z.setupGrid = l, z.draw = s, z.getPlaceholder = function() { return x }, z.getCanvas = function() { return d.element }, z.getPlotOffset = function() { return w }, z.width = function() { return M }, z.height = function() { return T }, z.offset = function() { var t = h.offset(); return t.left += w.left, t.top += w.top, t }, z.getData = function() { return C }, z.getAxes = function() { var e = {}; return q.each(p.concat(m), function(t, i) { i && (e[i.direction + (1 != i.n ? i.n : "") + "axis"] = i) }), e }, z.getXAxes = function() { return p }, z.getYAxes = function() { return m }, z.c2p = f, z.p2c = function(t) {
                var i, e, o, n = {};
                for (i = 0; i < p.length; ++i)
                    if ((e = p[i]) && e.used && (o = "x" + e.n, null == t[o] && 1 == e.n && (o = "x"), null != t[o])) { n.left = e.p2c(t[o]); break }
                for (i = 0; i < m.length; ++i)
                    if ((e = m[i]) && e.used && (o = "y" + e.n, null == t[o] && 1 == e.n && (o = "y"), null != t[o])) { n.top = e.p2c(t[o]); break }
                return n
            }, z.getOptions = function() { return S }, z.highlight = B, z.unhighlight = G, z.triggerRedrawOverlay = j, z.pointOffset = function(t) { return { left: parseInt(p[g(t, "x") - 1].p2c(+t.x) + w.left, 10), top: parseInt(m[g(t, "y") - 1].p2c(+t.y) + w.top, 10) } }, z.shutdown = a, z.destroy = function() { a(), x.removeData("plot").empty(), C = [], p = [], m = [], N = [], z = W = c = y = h = e = d = S = null }, z.resize = function() {
                var t = x.width(),
                    i = x.height();
            ...
            function(t) {
                ...
                var i, e, o, n = x.css("font-size"),
                    a = n ? +n.replace("px", "") : 13,
                    r = { style: x.css("font-style"), size: Math.round(.8 * a), variant: x.css("font-variant"), weight: x.css("font-weight"), family: x.css("font-family") };
            ...
            function() {
                x.css("padding", 0).children().filter(function() { return !q(this).hasClass("flot-overlay") && !q(this).hasClass("flot-base") }).remove(), "static" == x.css("position") && x.css("position", "relative");
        ...
        function L(t) { S.grid.hoverable && H("plothover", t, function(t) { return 0 != t.hoverable }) }

        function O(t) { S.grid.hoverable && H("plothover", t, function(t) { return !1 }) }

        function R(t) { H("plotclick", t, function(t) { return 0 != t.clickable }) }
        ...
        function H(t, i, e) {
            ...
            var l = function(t, i, e) {
                ...
                return s ? (o = s[0], n = s[1], a = C[o].datapoints.pointsize, { datapoint: C[o].datapoints.points.slice(n * a, (n + 1) * a), dataIndex: n, series: C[o], seriesIndex: o }) : null
            }(n, a, e);
        ...
        function j() { var t = S.interaction.redrawOverlayInterval; - 1 != t ? D || (D = setTimeout(E, t)) : E() }
        ...
        function B(t, i, e) {
            ...
            var n = _(t, i); - 1 == n ? (N.push({ series: t, point: i, auto: e }), j()) : e || (N[n].auto = !1)
        }
        ...
        function _(t, i) { for (var e = 0; e < N.length; ++e) { var o = N[e]; if (o.series == t && o.point[0] == i[0] && o.point[1] == i[1]) return e } return -1 }
        ...
        function X(t, i) {
            ...
            c.lineWidth = t.bars.lineWidth, c.strokeStyle = o, k(i[0], i[1], i[2] || 0, e, e + t.bars.barWidth, function() { return n }, t.xaxis, t.yaxis, c, t.bars.horizontal, t.bars.lineWidth)
        }
    ...
    q.fn.detach || (q.fn.detach = function() { return this.each(function() { this.parentNode && this.parentNode.removeChild(this) }) }), Q.prototype.resize = function(t, i) {
    ...
    }, Q.prototype.clear = function() { this.context.clearRect(0, 0, this.width, this.height) }, Q.prototype.render = function() {
        ...
        } else { var u; for (h = this.getTextInfo(t, o, n, a).positions, f = 0; u = h[f]; f++) u.x == i && u.y == e && (u.active = !1) }
    }, q.plot = function(t, i, e) { return new o(q(t), i, e, q.plot.plugins) }, q.plot.version = "0.8.3", q.plot.plugins = [], q.fn.plot = function(t, i) { return this.each(function() { q.plot(this, t, i) }) }
}(jQuery);
