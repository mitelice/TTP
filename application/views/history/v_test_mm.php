...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="../../assets/img/brand/1626529482.ico" type="image/png">
    <!-- Fonts -->
        ...
        <div class="scrollbar-inner">
            ...
            <div class="navbar-inner">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="tables.html">
                                <i class="fas fa-hand-point-down text-dark"></i>
                    ...
                    <!-- Divider -->
                    <span class="fas fa-user-circle text-dark" class="docs-normal" id="menu_divider">&nbsp;&nbsp; Documentation</span>
                    ...
                    <thead class="thead-light">
                        ...
                        <tbody class="list">
                            ...
                            <tr>
                                ...
                                <td>
                                    Argon Design Systemหัวฉีดน้ำมัน
                                </td>
                                <td>
